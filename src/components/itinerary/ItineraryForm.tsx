      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-5">
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 rounded-full px-4 py-2.5 text-[13px] font-semibold transition-all ${
                    isSelected
                      ...
                      : 'bg-slate-50 text-slate-600 shadow-sm hover:bg-slate-100 hover:shadow active:bg-slate-100'
                  }`}
                >
        ...
        <div className="mt-2 grid grid-cols-2 gap-3">
          <button
            ...
            className="h-12 rounded-[16px] bg-gradient-to-r from-[#7C3AED] to-[#8B5CF6] font-[family-name:var(--font-display)] text-[16px] font-bold text-white shadow-md transition-all hover:shadow-lg active:scale-[0.98] disabled:opacity-50"
          >
          ...
          <button
            type="button"
            onClick={onCancel}
            className="h-12 rounded-[16px] border border-slate-200 text-[15px] font-medium text-slate-500 transition-colors hover:bg-slate-50 active:bg-slate-100"
          >
            Cancel
          </button>
        </div>
        {onDelete && (
          <button
            type="button"
            onClick={onDelete}
            className="mt-1 self-center rounded-full px-4 py-1.5 text-[13px] font-medium text-red-400 transition-colors hover:bg-red-50 hover:text-red-500 active:bg-red-50 active:text-red-500"
          >
